...
public class TaskMeasureWeather : MonoBehaviour
{
    ...
    IEnumerator FinishTask()
    {
        ...
        while (timer < 10f)
        {
            ...
            {
                bars[i].value = timer / 10f * (3 - i);
                balloons[i].GetComponent<RectTransform>().anchoredPosition = new Vector2(balloons[i].GetComponent<RectTransform>().anchoredPosition.x + Time.deltaTime * (3 - i) * 100f, balloons[i].GetComponent<RectTransform>().anchoredPosition.y);
            }
