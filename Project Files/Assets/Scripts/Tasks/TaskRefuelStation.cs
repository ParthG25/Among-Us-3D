...
public class TaskRefuelStation : MonoBehaviour
{
    ...
    [SerializeField] private Slider bigTank, smallTank;
    ...
    private void Update()
    {
        ...
        if(TaskManager.Instance.activeTasks[serialNumber])
        {
            ...
            {
                bigTank.value += Time.deltaTime / 5;
                smallTank.value -= Time.deltaTime / 5;
            }
